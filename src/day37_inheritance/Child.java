...
public class Child extends Parent {
    ...
    Child(int s){
        //Child class'daki tum constructor'larin ilk satirina
        //Java'nin yerlestirdigi consturtor PARAMETRESIZ dir yani super()
    ...
    Child(int sayi1, int sayi2){
        ...
        //baska bir constructor'i calismak isterseniz
        //bunun icin Child class'taki constructor'in ILK SATIRINA yazmalisiniz
